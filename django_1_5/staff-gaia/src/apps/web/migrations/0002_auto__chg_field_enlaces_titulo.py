...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Enlaces.titulo'
        db.alter_column(u'web_enlaces', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=38))

    def backwards(self, orm):

        # Changing field 'Enlaces.titulo'
        db.alter_column(u'web_enlaces', 'titulo', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    models = {
        ...
        u'web.noticia': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'modified_by': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
