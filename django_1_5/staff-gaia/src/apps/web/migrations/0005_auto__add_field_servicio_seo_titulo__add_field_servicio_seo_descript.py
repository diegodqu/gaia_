...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Servicio.seo_titulo'
        db.add_column(u'web_servicio', 'seo_titulo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)

        # Adding field 'Servicio.seo_descript'
        db.add_column(u'web_servicio', 'seo_descript',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=320, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Servicio.seo_titulo'
        db.delete_column(u'web_servicio', 'seo_titulo')

        # Deleting field 'Servicio.seo_descript'
        db.delete_column(u'web_servicio', 'seo_descript')
    ...
    models = {
        ...
        u'web.contactohome': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombres': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'servicio': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
            'telefono': ('django.db.models.fields.CharField', [], {'max_length': '120'})
        },
        u'web.enlaces': {
        ...
        u'web.noticia': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'modified_by': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
        ...
        u'web.servicio': {
            ...
            'nombre1': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'posicion': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'seo_descript': ('django.db.models.fields.CharField', [], {'max_length': '320', 'blank': 'True'}),
            'seo_titulo': ('django.db.models.fields.CharField', [], {'max_length': '120', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '180', 'blank': 'True'}),
