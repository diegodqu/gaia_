...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactoHome.servicio'
        db.add_column(u'web_contactohome', 'servicio',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactoHome.servicio'
        db.delete_column(u'web_contactohome', 'servicio')
    ...
    models = {
        ...
        u'web.noticia': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 11, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'modified_by': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
